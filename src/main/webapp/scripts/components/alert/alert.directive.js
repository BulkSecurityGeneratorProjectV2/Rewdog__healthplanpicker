        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('healthPlanPickerApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-healthPlanPickerApp-error');
                                var entityKey = httpResponse.headers('X-healthPlanPickerApp-params');
                                if (errorHeader) {
